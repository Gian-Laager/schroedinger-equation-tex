...
The struct \rustinline{Newton'sMethodFindNewZero} is an extension to the function in snippet~\ref{code:newtons-method}, it can be used to find multiple roots.
