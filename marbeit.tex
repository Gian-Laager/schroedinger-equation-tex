...
\bashinline{perf stat} gathers performance counter statistics from a command~\citep{perfstat2022manula}.
...
Each pair of $\psi^{WKB}_{osc}$ and $\psi^{WKB}_{exp}$ will be plotted in different colors and the Airy functions will also be plotted seperately.
