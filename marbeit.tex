...
\\[3ex]
Shortly before I had to finish this paper, I realized that there was an interesting corresponds between the Dirac formalism and the architecture of the program. This happened by
...
used to its full extend~\citep{xylyxylyx2021dirac}. The problem with this idea is what the dual vector space to the superpositions should be and how it should be represented. The dual space can be
constructed with the inner product, but the question remains on how to define an inner product on two wave functions.
\\[3ex]
